...
protected void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    out.println("<title>Saque – Banco Campos</title>");
    out.println("<style>");
    ...
    out.println(".main-btn{width:100%;margin-top:16px;background:crimson;color:#fff;border:none;border-radius:6px;padding:12px;font-weight:600;cursor:pointer}");
    ...
    if (msg != null) {
        ...
        sessao.removeAttribute("msgSaque");
    }
    ...
    out.println("</div>");
    out.println("<button class='main-btn' type='submit'>Sacar</button>");
    out.println("</form>");
