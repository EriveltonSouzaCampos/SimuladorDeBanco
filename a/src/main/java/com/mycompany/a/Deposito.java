...
public class Deposito extends HttpServlet {
    ...
    // ajuste se seu host/porta ou usuário‑senha forem diferentes
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try (PrintWriter out = resp.getWriter()) {
            ...
            out.println("<html><head><title>Depósito</title>");
            out.println("<style>");
            ...
            if (msg != null){ out.println("<p style='color:green'>"+msg+"</p>"); sessao.removeAttribute("msgDeposito"); }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        // volta pro GET para atualizar saldo/mostrar msg
        resp.sendRedirect("deposito");
    }
}
